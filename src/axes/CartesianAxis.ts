...
export const cartesianAxisUnits = {
  x: {
    pos: 'x',
    len: 'width',
    dir: 'horizontal',
...
export type XAxisUnits = typeof cartesianAxisUnits.x;
export type YAxisUnits = typeof cartesianAxisUnits.y;
export type CartesianAxisUnits = XAxisUnits | YAxisUnits;
...
export abstract class CartesianAxis extends Axis {
  ...
  constructor(units: CartesianAxisUnits, chartRect: ChartRect, ticks: Label[]) {
    ...
    this.counterUnits =
      units === cartesianAxisUnits.x
        ? cartesianAxisUnits.y
        : cartesianAxisUnits.x;
  }

  override createGridAndLabels(
    gridGroup: Svg,
    labelGroup: Svg,

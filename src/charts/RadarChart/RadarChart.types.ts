...
export type RadarLineInterpolation = (
  pathCoordinates: number[],
  valueData: SegmentData[]
) => SvgPath;

export type RadarChartData = Data<(Series | SeriesObject)[]>;
...
> extends Options<TXAxisOptions, TYAxisOptions> {
   ...
   */
  lineSmooth?: boolean | RadarLineInterpolation;
  /**
  ...
  series?: Record<
    string,
    Omit<RadarChartOptions<TXAxisOptions, TYAxisOptions>, 'series'>
  >;
}

export type RadarChartOptionsWithDefaults = RequiredKeys<
  RadarChartOptions<
    RequiredKeys<
      AxisOptions,
      | 'offset'
...
export type RadarChartCreatedEvent = CreatedEvent<RadarChartOptions>;

export interface RadarPointDrawEvent extends DrawEvent {
  type: 'point';
...
export interface RadarLineDrawEvent extends DrawEvent {
  type: 'line';
  values: NormalizedSeries;
  path: SvgPath;
}

export interface RadarAreaDrawEvent extends DrawEvent {
  type: 'area';
  values: NormalizedSeries;
  path: SvgPath;
}

export type RadarChartEventsTypes = BaseChartEventsTypes<
  RadarChartCreatedEvent,
  AxesDrawEvent | RadarPointDrawEvent | RadarLineDrawEvent | RadarAreaDrawEvent
>;

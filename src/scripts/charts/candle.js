...
(function(window, document, Chartist){
  ...
  var defaultOptions = {
    ...
    // Inverts the axes of the candle stick chart in order to draw a horizontal candle stick chart. Be aware that you also need to invert your axis settings as the Y Axis will now display the labels and the X Axis the values.
    horizontalBars: false,
    // If set to true then each bar will represent a series and the data array is expected to be a one dimensional array of data values rather than a series array of series. This is useful if the candle stick chart should represent a profile rather than some data over time.
   ...
   *
   * @example
   * // Create a simple candle stick chart
   * var data = {
   ...
   * };
   *
   * // In the global name space Chartist we call the Bar function to initialize a candle stick chart. As a first parameter we pass in a selector where we would like to get our chart created and as a second parameter we pass our data object.
   * new Chartist.Candle('.ct-chart', data);
   *
   * @example
   * // This example creates a bipolar grouped candle stick chart where the boundaries are limitted to -10 and 10

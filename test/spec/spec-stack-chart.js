describe('Stack chart tests', function () {
    'use strict';
    ...
    describe('grids', function() {
        ...
        function onCreated(fn) {
            ...
            chart = new Chartist.Stack('.ct-chart', data, options);
            chart.on('created', fn);
        }
        ...
        //     onCreated(function () {
        //         expect($('g.ct-grids line.ct-grid.ct-horizontal').length).toBe(4);
    ...
    //         jasmine.getFixtures().set('<div class="ct-chart ct-golden-section"></div>');
    //         var chart = new Chartist.Stack('.ct-chart', data, options);
    ...
    //         jasmine.getFixtures().set('<div class="ct-chart ct-golden-section"></div>');
    //
    //         var chart = new Chartist.Stack('.ct-chart', {
    //             series: [[
    //                 {x: 1, y: 2},
    //                 {x: 3, y: 4}
    //             ]]
    ...
    //         };
    //
    //         var chart = new Chartist.Stack('.ct-chart', data);
    //
    //         chart.on('created', function () {
    ...
    //         jasmine.getFixtures().set('<div class="ct-chart ct-golden-section"></div>');
    //
    //         var chart = new Chartist.Stack('.ct-chart', null, {
    //             width: 400,
    //             height: 300,
    //             high: 100,
    //             low: -100

 ...
 */
function safeHasProperty(object, property) {
 ...
 * @returns {*}
 */
function getMetaData(series, index) {
 ...
 */
function getDataArray(data, reverse, multi) {
...
var Svg = function () {
  ...
  _createClass(Svg, [{
    ...
    key: 'elem',
    value: function elem(name, attributes, className, insertFirst) {
    ...
    key: 'foreignObject',
    value: function foreignObject(content, attributes, className, insertFirst) {
    ...
    key: 'append',
    value: function append(element, insertFirst) {
      ...
      Object.keys(animations).forEach(function (attribute) {
        ...
        var createAnimate = function createAnimate(animationDefinition, createGuided) {
          ...
          if (animationDefinition.easing) {
            ...
            animationEasing = animationDefinition.easing instanceof Array ? animationDefinition.easing : easings[animationDefinition.easing];
 ...
 */
function createChartRect(svg, options, fallbackPadding) {
...
var EventEmitter = function () {
  ...
  _createClass(EventEmitter, [{
    ...
    value: function removeEventHandler(event, handler) {
...
var BaseChart = function () {
  ...
  _createClass(BaseChart, [{
    ...
    key: 'update',
    value: function update(data, options, override) {
      if (data) {
        this.data = data || {};
        this.data.labels = this.data.labels || [];
        this.data.series = this.data.series || [];
...
var Axis = function () {
  ...
  _createClass(Axis, [{
    key: 'initialize',
    value: function initialize(units, chartRect, ticks, options) {
      this.units = units;
    ...
    key: 'projectValue',
    value: function projectValue(value, index, data) {
...
var AutoScaleAxis = function (_Axis) {
  ...
  function AutoScaleAxis(axisUnit, data, chartRect, options) {
    ...
    var _this = _possibleConstructorReturn(this, (AutoScaleAxis.__proto__ || Object.getPrototypeOf(AutoScaleAxis)).call(this));

    var highLow = options.highLow || getHighLow(data, options, axisUnit.pos);
    _this.bounds = getBounds(chartRect[axisUnit.rectEnd] - chartRect[axisUnit.rectStart], highLow, options.scaleMinSpace || 20, options.onlyInteger);
    _this.range = {
      min: _this.bounds.min,
      max: _this.bounds.max
    };

    _get(AutoScaleAxis.prototype.__proto__ || Object.getPrototypeOf(AutoScaleAxis.prototype), 'initialize', _this).call(_this, axisUnit, chartRect, _this.bounds.values, options);
    return _this;
  }
...
var FixedScaleAxis = function (_Axis) {
  _inherits(FixedScaleAxis, _Axis);

  function FixedScaleAxis(axisUnit, data, chartRect, options) {
    _classCallCheck(this, FixedScaleAxis);

    var _this = _possibleConstructorReturn(this, (FixedScaleAxis.__proto__ || Object.getPrototypeOf(FixedScaleAxis)).call(this));
    ...
    _get(FixedScaleAxis.prototype.__proto__ || Object.getPrototypeOf(FixedScaleAxis.prototype), 'initialize', _this).call(_this, axisUnit, chartRect, _this.ticks, options);

    _this.stepLength = _this.axisLength / _this.divisor;
    return _this;
  }
...
var StepAxis = function (_Axis) {
  _inherits(StepAxis, _Axis);

  function StepAxis(axisUnit, data, chartRect, options) {
    _classCallCheck(this, StepAxis);

    var _this = _possibleConstructorReturn(this, (StepAxis.__proto__ || Object.getPrototypeOf(StepAxis)).call(this));

    _get(StepAxis.prototype.__proto__ || Object.getPrototypeOf(StepAxis.prototype), 'initialize', _this).call(_this, axisUnit, chartRect, options.ticks, options);

    var calc = Math.max(1, options.ticks.length - (options.stretch ? 1 : 0));
    _this.stepLength = _this.axisLength / calc;
    return _this;
  }

  _createClass(StepAxis, [{
    key: 'projectValue',
    value: function projectValue(value, index) {
...
var SvgPath = function () {
  _createClass(SvgPath, null, [{
     ...
     * @return {SvgPath}
     */
    value: function join(paths, close, options) {
  ...
  _createClass(SvgPath, [{
    ...
    key: 'move',
    value: function move(x, y, relative, data) {
      element('M', {
        x: +x,
        y: +y
    ...
    key: 'line',
    value: function line(x, y, relative, data) {
      element('L', {
        x: +x,
        y: +y
      }, this.pathElements, this.pos++, relative, data);
    ...
    key: 'curve',
    value: function curve(x1, y1, x2, y2, x, y, relative, data) {
      element('C', {
        x1: +x1,
        y1: +y1,
        x2: +x2,
    ...
    key: 'arc',
    value: function arc(rx, ry, xAr, lAf, sf, x, y, relative, data) {
      element('A', {
        rx: +rx,
        ry: +ry,
        xAr: +xAr,
...
var BarChart = function (_BaseChart) {
  ...
  function BarChart(query, data, options, responsiveOptions) {
    ...
    return _possibleConstructorReturn(this, (BarChart.__proto__ || Object.getPrototypeOf(BarChart)).call(this, query, data, defaultOptions$2, extend({}, defaultOptions$2, options), responsiveOptions));
  }
  ...
  _createClass(BarChart, [{
    ...
    value: function createChart(options) {
      ...
      this.svg = createSvg(this.container, options.width, options.height, options.classNames.chart + (options.horizontalBars ? ' ' + options.classNames.horizontalBars : ''));
...
var PieChart = function (_BaseChart) {
  ...
  function PieChart(query, data, options, responsiveOptions) {
    ...
    return _possibleConstructorReturn(this, (PieChart.__proto__ || Object.getPrototypeOf(PieChart)).call(this, query, data, defaultOptions$3, extend({}, defaultOptions$3, options), responsiveOptions));
  }
  ...
  _createClass(PieChart, [{
    ...
    value: function createChart(options) {
      ...
      data.raw.series.forEach(function (series, index) {
        ...
        // Use series class from series data or if not set generate one
        seriesGroups[index].addClass([options.classNames.series, series.className || options.classNames.series + '-' + alphaNumerate(index)].join(' '));
